...
export default function VerificationRequestScreen() {
    ...
    // CARD WIDTH - Must match the className w-[405px]
    ...
    const handleSubmit = () => {
        ...
        const referenceNumber = `VER-${new Date().getFullYear()}-${Math.random().toString(36).substr(2, 6).toUpperCase()}`;
        ...
        setTimeout(() => {
            Alert.alert(
                ...
                [
                    {
                        text: 'Track Request',
                        onPress: () => navigation.navigate('TrackRequest', { referenceNumber }),
                    },
                    {
                        text: 'Submit Another',
                        style: 'cancel',
            ...
            >
                <View className="flex-1">
                    ...
                    >
                        ...
                        {/* ✅ Horizontal ScrollView - Each section card scrolls VERTICALLY */}
                        <ScrollView
                            ref={scrollViewRef}
                            horizontal
                            pagingEnabled
